//! Slave fixture for the two-board FRDM-KL82Z SPI test.
//!
//! Flash `spi_link_master` to the other board and connect the boards as described in the test
...
//! The master must leave at least this much time between exchanges. This fixture runs until reset;
//! the master reports the test verdict.
#![no_std]
#![no_main]
...
use embassy_nxp_mkl82z7_tests::spi_link::{FRAME_LEN, reply};
