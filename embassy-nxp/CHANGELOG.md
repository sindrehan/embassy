...
- MKL82Z7 (Kinetis KL82): chip support with clock gating (`clocks`), GPIO, watchdog disable, a TPM time driver (`time-driver-tpm`) system clock configuration (FEI, PLL, BLPI) and an LPUART driver (blocking and async)
